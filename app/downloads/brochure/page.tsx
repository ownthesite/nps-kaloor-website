    ...
    <main className="min-h-screen bg-slate-100 py-4 sm:py-8">
      <div className="mx-auto max-w-7xl px-2 sm:px-6">
        ...
        <div className="mb-6 flex flex-col gap-4 rounded-3xl bg-white p-5 shadow-lg sm:flex-row sm:items-center sm:justify-between sm:p-6">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href={pdfUrl}
              download
              className="inline-flex items-center gap-2 rounded-2xl bg-[#0c2d83] px-5 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-[#163b9c]"
            >
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-[210mm] overflow-hidden rounded-xl bg-white shadow-2xl">
            <div className="relative aspect-[1/1.4142] w-full bg-slate-200">
              <iframe
